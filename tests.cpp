...
TEST_F(HashTableProjectTests, TestHashTableInsert)
{
    ...
    EXPECT_TRUE(t.mChainArray[0] == nullptr) << "The rehash should cause chains 0 and 3 to be empty.";
    EXPECT_TRUE(t.mChainArray[3] == nullptr) << "The rehash should cause chains 0 and 3 to be empty.";
    EXPECT_TRUE(t.mChainArray[2]->mValue == "large") << "The value inserted "
                    "for key 'grow' should = 'large'.";
    EXPECT_TRUE(t.mChainArray[1]->mValue == "123") << "The rehash should not lose "
                    "any nodes.";
    EXPECT_TRUE(t.mChainArray[1]->mNext->mValue == "; )") << "The rehash should not lose "
                    "any nodes.";
}
